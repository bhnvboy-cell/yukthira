...
public class BinEntity : EntityBase { public Guid TenantId { get; set; } public string WarehouseNumber { get; set; } = ""; public string StorageType { get; set; } = ""; public string StorageSection { get; set; } = ""; public string BinCode { get; set; } = ""; public decimal MaxWeight { get; set; } public decimal MaxVolume { get; set; } public string PutawayStrategy { get; set; } = "Open"; public string BinType { get; set; } = "Standard"; public string Status { get; set; } = "Active"; public decimal CurrentWeight { get; set; } public decimal CurrentVolume { get; set; } }
public class TransferOrderEntity : EntityBase { public Guid TenantId { get; set; } public string OrderNumber { get; set; } = ""; public string MaterialCode { get; set; } = ""; public string MaterialName { get; set; } = ""; public string SourceBin { get; set; } = ""; public string DestinationBin { get; set; } = ""; public decimal Quantity { get; set; } public string BaseUOM { get; set; } = "EA"; public string TargetBatch { get; set; } = ""; public string MovementType { get; set; } = "999"; public string AssignedOperator { get; set; } = ""; public string Status { get; set; } = "Created"; public DateTime OrderDate { get; set; } }
public class WaveEntity : EntityBase { public Guid TenantId { get; set; } public string WaveNumber { get; set; } = ""; public string DeliveryNotes { get; set; } = ""; public int Priority { get; set; } public string AssignedZone { get; set; } = ""; public DateTime CutoffTime { get; set; } public int ItemCount { get; set; } public string Status { get; set; } = "Planned"; }
public class InventoryCountEntity : EntityBase { public Guid TenantId { get; set; } public string CountNumber { get; set; } = ""; public string WarehouseNumber { get; set; } = ""; public string StorageType { get; set; } = ""; public string BinRange { get; set; } = ""; public string CountType { get; set; } = "Full"; public string AssignedTo { get; set; } = ""; public DateTime ScheduledDate { get; set; } public int TotalBins { get; set; } public int CountedBins { get; set; } public string Status { get; set; } = "Planned"; }
...
// HR
public class EmployeeEntity : EntityBase { public Guid TenantId { get; set; } public string Code { get; set; } = ""; public string Name { get; set; } = ""; public string Department { get; set; } = ""; public string Designation { get; set; } = ""; public string Mobile { get; set; } = ""; public string Status { get; set; } = "Active"; public string PersonnelNumber { get; set; } = ""; public string CompanyCode { get; set; } = ""; public string PersonnelArea { get; set; } = ""; public string OrgUnitCode { get; set; } = ""; public string Position { get; set; } = ""; public string EmployeeGroup { get; set; } = "Permanent"; public decimal BasicSalary { get; set; } public string CostCenter { get; set; } = ""; public string PaymentMethod { get; set; } = "Bank Transfer"; public string Email { get; set; } = ""; public DateTime? DateOfBirth { get; set; } public DateTime? JoiningDate { get; set; } }
...
public class OrgUnitEntity : EntityBase { public Guid TenantId { get; set; } public string UnitCode { get; set; } = ""; public string UnitName { get; set; } = ""; public string UnitType { get; set; } = "Department"; public string ParentUnit { get; set; } = ""; public string Manager { get; set; } = ""; public string CostCenter { get; set; } = ""; public int Headcount { get; set; } public string Location { get; set; } = ""; public string Status { get; set; } = "Active"; }
public class TimeEntryEntity : EntityBase { public Guid TenantId { get; set; } public string EntryId { get; set; } = ""; public string EmployeeCode { get; set; } = ""; public string EmployeeName { get; set; } = ""; public DateTime EntryDate { get; set; } public string EntryType { get; set; } = "Work"; public decimal Hours { get; set; } public string ProjectCode { get; set; } = ""; public string Description { get; set; } = ""; public string Status { get; set; } = "Submitted"; public string ApprovedBy { get; set; } = ""; }
public class RecruitmentEntity : EntityBase { public Guid TenantId { get; set; } public string RequisitionId { get; set; } = ""; public string JobTitle { get; set; } = ""; public string Department { get; set; } = ""; public string Position { get; set; } = ""; public int Headcount { get; set; } public string HiringManager { get; set; } = ""; public string Priority { get; set; } = "Normal"; public string EmploymentType { get; set; } = "Full-Time"; public decimal MinSalary { get; set; } public decimal MaxSalary { get; set; } public string Justification { get; set; } = ""; public DateTime RequestedDate { get; set; } public DateTime? TargetDate { get; set; } public string Status { get; set; } = "Open"; public int ApplicantsCount { get; set; } }
...
public class OpportunityEntity : EntityBase { public string OppId { get; set; } = ""; public string OpportunityName { get; set; } = ""; public string Company { get; set; } = ""; public decimal Value { get; set; } public string Stage { get; set; } = ""; public string Status { get; set; } = "Open"; public string AccountId { get; set; } = ""; public string ContactPerson { get; set; } = ""; public string SalesOrg { get; set; } = ""; public string DistributionChannel { get; set; } = ""; public string SalesStage { get; set; } = "Prospecting"; public decimal ClosingProbability { get; set; } public decimal TargetValue { get; set; } public DateTime? ExpectedCloseDate { get; set; } public string ProductItems { get; set; } = ""; public string AssignedTo { get; set; } = ""; }
...
public class ServiceTicketEntity : EntityBase { public string TicketId { get; set; } = ""; public string CustomerName { get; set; } = ""; public string Subject { get; set; } = ""; public string Priority { get; set; } = "Medium"; public string Status { get; set; } = "Open"; public DateTime CreatedDate { get; set; } public string TicketType { get; set; } = "Complaint"; public string Category { get; set; } = ""; public string AssignedTo { get; set; } = ""; public string Resolution { get; set; } = ""; public DateTime? ResolvedDate { get; set; } public string CustomerEmail { get; set; } = ""; public string CustomerPhone { get; set; } = ""; }
public class CrmAccountEntity : EntityBase { public Guid TenantId { get; set; } public string AccountId { get; set; } = ""; public string AccountName { get; set; } = ""; public string AccountType { get; set; } = "Customer"; public string Industry { get; set; } = ""; public string Website { get; set; } = ""; public string Phone { get; set; } = ""; public string Email { get; set; } = ""; public string Address { get; set; } = ""; public string City { get; set; } = ""; public string Country { get; set; } = ""; public string Currency { get; set; } = "USD"; public string PaymentTerms { get; set; } = ""; public string CreditLimit { get; set; } = ""; public string AssignedTo { get; set; } = ""; public string Status { get; set; } = "Active"; }
public class SalesPipelineEntity : EntityBase { public Guid TenantId { get; set; } public string PipelineId { get; set; } = ""; public string DealName { get; set; } = ""; public string AccountName { get; set; } = ""; public string ContactPerson { get; set; } = ""; public string Stage { get; set; } = "Prospecting"; public decimal DealValue { get; set; } public decimal WinningProbability { get; set; } public DateTime ExpectedCloseDate { get; set; } public string ProductLine { get; set; } = ""; public string SalesOrg { get; set; } = ""; public string AssignedTo { get; set; } = ""; public string Notes { get; set; } = ""; public string Status { get; set; } = "Open"; }
...
public class StockMovementEntity : EntityBase { public Guid TenantId { get; set; } public string DocumentNumber { get; set; } = ""; public string MaterialName { get; set; } = ""; public string MovementType { get; set; } = ""; public decimal Quantity { get; set; } public decimal StockBefore { get; set; } public decimal StockAfter { get; set; } public string Reference { get; set; } = ""; public string Status { get; set; } = "Posted"; public string MaterialCode { get; set; } = ""; public string SourceBin { get; set; } = ""; public string DestinationBin { get; set; } = ""; public string UOM { get; set; } = "EA"; public string BatchNumber { get; set; } = ""; public string PostedBy { get; set; } = ""; public DateTime MovementDate { get; set; } public string MovementNumber { get; set; } = ""; }
