...
public class CreateModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync() { if (!ModelState.IsValid) return Page(); await _repo.AddAsync(Ticket); return RedirectToPage("/CRM/ServiceTicket/List"); }
}
